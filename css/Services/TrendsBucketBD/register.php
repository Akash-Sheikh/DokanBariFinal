...
<body>
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="ImageSrc/logo.png" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form action="registerAction.php" method="POST">
        <input type="text" id="login"  name="uname" placeholder="User name" required>
        <input type="email" id="login"  name="email" placeholder="Email address" required>
