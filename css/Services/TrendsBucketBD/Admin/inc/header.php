		        ...
		        <ul class="navbar-nav mr-auto">
			      ...
			      <li class="nav-item dropdown">
			        ...
			        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="color: #fff;background-color: #000000;">
			          ...
			          <a class="dropdown-item" href="ManagerList.php" style="color: white">Manager List</a>
			          <a class="dropdown-item" href="ManagerDeleteList.php" style="color: white">Remove Manager</a>
