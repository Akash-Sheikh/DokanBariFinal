...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/materialize/0.98.2/css/materialize.min.css'><link rel="stylesheet" href="css/ManagerLogin.css">
...
<br>
      ...
      <div class="container">
        ...
        <div class="card login hoverable">
          ...
          <form class="col s12" action="ManagerLoginPhpCode.php" method="POST">
            <div class="row">
