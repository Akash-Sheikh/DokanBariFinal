...
<style type="text/css">
    ...
    <div id="body" style=" ">
        ...
        <div class="card" style="margin-left: 10px; margin-right: 10px; background: #fff;"> 
          ...
          <div class="card-body" >
                    ...
                    <input class="btn btn-primary Addbtn" style="border-color: #155724; background-color: #006837; color: #efefed;" type="button" id="add" value="Add Category"/><br/><br/>
